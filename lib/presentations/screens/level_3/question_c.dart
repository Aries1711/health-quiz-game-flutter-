...
class _QuestionCThreeState extends State<QuestionCThree> {
  ...
  launchDescriptionUrl() async {
    ...
    Uri surveyUrlPatch = Uri.parse('https://youtu.be/7mFrgNNFtz4');
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text(
                        "Jawaban : RICE – rest, ice, compression dan elevation\nPenjelasan : prinsip penanganan awal yang dilakukan pada cedera otot dan persedian ekstremitas adalah rest, ice, compression and elevation (RICE).\na.	Rest = tidak menggunakan atau menggerakkan bagian yang mengalami\nb.	Ice = letakkan ice pack pada area cedera sekitar 10-20 menit. Tidak diperkenankan meletakkan ice pack langsung pada kulit. \nc.	Compression = lakukan kompresi dengan bandage pada area cedera sekitar 3-4 jam\nd.	Elevation = Tinggikan area cedera lebih tinggi dari jantung jika memungkinkan",
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: ButtonGeneralSecondary(
                        ...
                        backgroundColor: colorPurplePrimary,
                        widgetChild: Text(
                          "RICE – run ice correlation elevation",
                          style: GoogleFonts.rubik(
                            textStyle: TextStyle(
                              fontWeight: FontWeight.w700,
                              color: colorWhite,
                    ...
                    Padding(
                      ...
                      child: ButtonGeneralSecondary(
                        ...
                        backgroundColor: colorPurplePrimary,
                        widgetChild: Text(
                          "PQRST = pain, quality, regio, severity, time ",
                          style: GoogleFonts.rubik(
                            textStyle: TextStyle(
                              fontWeight: FontWeight.w700,
                              color: colorWhite,
