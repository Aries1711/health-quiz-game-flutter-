                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text(
                        "Jawaban : Segera mengistirahatkan area yang sakit\nPenjelasan : tindakan yang harus diaplikasikan pertama kali pada kasus cedera yang berhubungan dengan ekstremitas sesuai prinsip RICE adalah REST = mengistirahatkan area yang cedera dengan tujuan mencegah cedera makin parah.",
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: ButtonGeneralSecondary(
                        ...
                        backgroundColor: colorPurplePrimary,
                        widgetChild: Text(
                          "Segera mengistirahatkan area yang sakit",
                          style: GoogleFonts.rubik(
                            textStyle: TextStyle(
                              fontWeight: FontWeight.w700,
                              color: colorWhite,
                    ...
                    Padding(
                      ...
                      child: ButtonGeneralSecondary(
                        ...
                        backgroundColor: colorPurplePrimary,
                        widgetChild: Text(
                          "Segera meninggikan area yang sakit",
                          style: GoogleFonts.rubik(
                            textStyle: TextStyle(
                              fontWeight: FontWeight.w700,
                              color: colorWhite,
                    ...
                    Padding(
                      ...
                      child: ButtonGeneralSecondary(
                        ...
                        backgroundColor: colorPurplePrimary,
                        widgetChild: Text(
                          "Segera mengompres area yang sakit",
                          style: GoogleFonts.rubik(
                            textStyle: TextStyle(
                              fontWeight: FontWeight.w700,
                              color: colorWhite,
