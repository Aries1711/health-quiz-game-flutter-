                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text(
                        "Jawaban : Hindari kontak langsung antara es dengan kulit (kompres langsung)\nPenjelasan : Prinsip ICE (kompres es pada area cedera) berfungsi untuk mengurangi pembengkakan, nyeri dan spasme (kaku otot). Namun dalam pengaplikasiannya, hindari penempelan langsung es dengan kulit agar tidak terjadi syok pada area cedera.",
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: ButtonGeneralSecondary(
                        ...
                        backgroundColor: colorPurplePrimary,
                        widgetChild: Text(
                          "Hindari kontak langsung antara es dengan kulit (kompres langsung)",
                          textAlign: TextAlign.center,
                          style: GoogleFonts.rubik(
                            textStyle: TextStyle(
                              fontWeight: FontWeight.w700,
                    ...
                    Padding(
                      ...
                      child: ButtonGeneralSecondary(
                        ...
                        backgroundColor: colorPurplePrimary,
                        widgetChild: Text(
                          "Kompres langsung es batu pada area yang bengkak",
                          textAlign: TextAlign.center,
                          style: GoogleFonts.rubik(
                            textStyle: TextStyle(
                              fontWeight: FontWeight.w700,
