...
class _QuestionETwoState extends State<QuestionETwo> {
  ...
  launchDescriptionUrl() async {
    ...
    Uri surveyUrlPatch =
        Uri.parse('https://www.youtube.com/watch?v=Tx_2KB6q6MY');
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Text(
                        "Jawaban : Tekan luka dengan kuat menggunakan penutup\nPenjelasan : Dalam melakukan kontrol perdarahan luar pada luka yang harus segera dilakukan adalan dengan menekan secara langsung dengan kuat menggunakan penutup. Penutup yang dapat digunakan adalah plastik, kain atau pun bahan lainnya yang dapat digunakan. Apabila ada luka berdarah yang masih terhalang baju/kain yang masih melekat, maka yang harus dilakukan pertama kali adalah membebaskan area yang terluka dengan menggunting baju/kain tersebut agar luka lebih bebas dalam penolong memberikan perawatan.",
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: ButtonGeneralSecondary(
                        ...
                        backgroundColor: colorPurplePrimary,
                        widgetChild: Text(
                          "Tekan luka dengan kuat menggunakan penutup",
                          textAlign: TextAlign.center,
                          style: GoogleFonts.rubik(
                            textStyle: TextStyle(
                              fontWeight: FontWeight.w700,
